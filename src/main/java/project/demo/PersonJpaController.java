...
import project.demo.exceptions.NonexistentEntityException;
import project.demo.exceptions.PreexistingEntityException;
...
public class PersonJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("project_demo_jar_0.0.1-SNAPSHOTPU");
